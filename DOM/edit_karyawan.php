...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <div class="col-6">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="nama" name="nama" aria-describedby="" value="<?php echo htmlentities($row_karyawan['nama'], ENT_COMPAT, 'utf-8'); ?>" size="32">
    </div>

    <div class="mb-3">
      <label for="alamat" class="form-label">Alamat</label>
      <input type="text" class="form-control" id="alamat" name="alamat" aria-describedby="" value="<?php echo htmlentities($row_karyawan['alamat'], ENT_COMPAT, 'utf-8'); ?>" size="32">
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="unit" name="unit" aria-describedby="" value="<?php echo htmlentities($row_karyawan['unit'], ENT_COMPAT, 'utf-8'); ?>" size="32">
    </div>
  ...
  <div class="col-6">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="username" name="username" aria-describedby="" value="<?php echo htmlentities($row_karyawan['username'], ENT_COMPAT, 'utf-8'); ?>" size="32">
    </div>
